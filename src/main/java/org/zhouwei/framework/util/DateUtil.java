...
import org.zhouwei.framework.enums.DateStyle;
import org.zhouwei.framework.enums.Week;
...
public class DateUtil {
    ...
    /**
     * 获取日期信息 从当前日期 计算 比如：day=1 往后一天，day=-1 往前一天
     * @param day
     * @return
     * @author ZHOUWEI4
     */
    public static Date getDateByLastDay(int day){
    ...
    public static String getTime(int count, Integer calendarTime, String formatter) {
        Calendar cal = Calendar.getInstance();
        cal.add(calendarTime, count);   // int amount   代表天数
        Date datNew = cal.getTime();
     ...
     * 获取前X分钟的日期
     */
    public static Date getPrefixMinutes(Integer count) {
        Calendar cal = Calendar.getInstance();
        int minutes = 0 - count;
        cal.add(Calendar.MINUTE, minutes);   // int amount   代表分钟
        return cal.getTime();
    }
     ...
     * 获取前X分钟的日期
     */
    public static Date getPrefixMinutes(Date date, Integer count) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        int minutes = 0 - count;
        cal.add(Calendar.MINUTE, minutes);   // int amount   代表分钟
     ...
     * 获取前X小时的日期
     */
    public static Date getPrefixHours(Date date, Integer count) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        int minutes = 0 - count;
        cal.add(Calendar.HOUR, minutes);   // int amount   代表小时
        return cal.getTime();
    }
